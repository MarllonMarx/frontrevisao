...
//funçao para alimentar os selects para listar alunos e turmas
...
function Tabela (){
    ...
    .then(
        (response)=>{
            ...
            let table = document.getElementById('table-matricula')
            let html = ''
